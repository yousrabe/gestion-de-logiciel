                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         <div class="zoneAdd">
                                <input type="text" class="myInput" placeholder="Type" name="cat_type">
                                <input type="text" class="myInput" placeholder="Description" name="cat_desc">
                                <button class="btn btn-danger" id="addcat"><i class="glyphicon glyphicon-ok"></i> Ajouter</button>
                            </div>
...
<sql:query dataSource="${jee_base1}" var="result"> SELECT * from categories;</sql:query>
                                    <c:forEach var="categorie" items="${result.rows}" >
                                        <tr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                          <label for="usr">Type Categorie</label>
                                          <input type="text" class="form-control" value="aaa" name="ecre1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="usr">Description Categorie</label>
