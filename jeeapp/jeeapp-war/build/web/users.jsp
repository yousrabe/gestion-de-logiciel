                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="composant.html">
                                <i class="far fa-check-square"></i>Composants</a>
                        </li>
                        <li>
                            <a href="users.html">
                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         <div class="zoneAdd">
                                <button onclick="myFunction()"  class="btn btn-danger" id="adduserb" ><i class="glyphicon glyphicon-ok"></i> New User</button>
                            </div>

                            <div class="zoneAdd" id="adduser"style="display: none">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                          <label for="usr">Nom :</label>
                                          <input type="text" class="form-control" name="cre1">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                          <label for="usr">Prénom :</label>
                                          <input type="text" class="form-control" name="cre2">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                          <label for="usr">Date de naissance :</label>
                                          <input type="text" class="form-control" name="cre3">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="cre4">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <SELECT class="form-control" name="cre5" size="1">
                                          <OPTION>Homme
                                          <OPTION>Femme
                                          </SELECT>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="cre6">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="cre7">
                                        </div>
                                    </div>                                 
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <button class="btn btn-danger" id="addResponsable"><i class="glyphicon glyphicon-ok"></i> Ajouter</button>
                                    </div>
                                </div>
...
<sql:query dataSource="${jee_base1}" var="result"> SELECT * from utilisateurs ;</sql:query>                                
        ...
        <div class="zoneAdd" >
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <input type="date" class="form-control" value="bbb" name="ecre2">
                                        </div>
                                    </div>
                                         <input type="hidden" value="id" name="ecre0">
                                        <div class="form-group">
                                          <label for="usr">Email </label>
                                          <input type="Email" class="form-control" value="aaa" name="ecre1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="usr">Password </label>
                                          <input type="Password" class="form-control" value="bbb" name="ecre2">
                                        </div>
                                    </div>
