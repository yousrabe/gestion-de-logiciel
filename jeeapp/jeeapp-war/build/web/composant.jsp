                   ...
                   <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         <div class="zoneAdd">
                                <input type="text" class="myInput" placeholder="Nom" name="com_nom">
                                <input type="text" class="myInput" placeholder="Description" name="com_desc">
                                <input type="text" class="myInput" placeholder="Dependency" name="com_depen">
...
<sql:query dataSource="${jee_base1}" var="result"> SELECT * from composants ;</sql:query>                                
                                         <c:forEach items="${result.rows}" var="composant">
                                        <tr>
                                            <td>${composant.codeComposant}</td>
                                            <td>${composant.nomComposant}</td>
                                            <td>${composant.descriptionComposant}</td>
                                            <td>${composant.dependencyComposant}</td>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                          <label for="usr">Nom Composant</label>
                                          <input type="text" class="form-control" value="aaa" name="ecre1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="usr">Description Composant</label>
                                          <input type="text" class="form-control" value="bbb" name="ecre2">
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                        <div class="form-group">
                                          <label for="usr">Dependency Composant</label>
                                          <input type="text" class="form-control" value="bbb" name="ecre2">
                                        </div>
                                    </div>
